...
class FontSizes {
  ...
  final double smallerFontSize6;   // 5th font size smaller than baseFontSize
  final double smallerFontSize7;   // 5th font size smaller than baseFontSize
  final double smallerFontSize8;   // 5th font size smaller than baseFontSize
  final double smallerFontSize9;   // 5th font size smaller than baseFontSize
  final double smallerFontSize10;   // 5th font size smaller than baseFontSize
  ...
  FontSizes({
    required this.smallerFontSize10,
    required this.smallerFontSize9,
    required this.smallerFontSize8,
    required this.smallerFontSize7,
    required this.smallerFontSize6,
  ...
  factory FontSizes.fromContext(BuildContext context) {
    ...
    return FontSizes(
      ...
      smallerFontSize6: baseFontSize * 0.4,   // 5th font size smaller
      smallerFontSize7: baseFontSize * 0.3,   // 5th font size smaller
      smallerFontSize8: baseFontSize * 0.2,   // 5th font size smaller
      smallerFontSize9: baseFontSize * 0.1,   // 5th font size smaller
      smallerFontSize10: baseFontSize * 0.09,   // 5th font size smaller
